...
expName = 'Debolina_Tutorial 5'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\debol\\Desktop\\PsychoPy\\Debolina_Tutorial 5_lastrun.py',
...
trials_2 = data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('C:/Users/debol/Desktop/PsychoPy/test.xlsx'),
